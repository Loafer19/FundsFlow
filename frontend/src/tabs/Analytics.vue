<template>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div class="card card-border border-base-300 bg-base-100">
            <div class="card-body">
                <h2 class="card-title">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="text-info">
                        <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div class="card card-border border-base-300 bg-base-100">
            <div class="card-body">
                <h2 class="card-title">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="text-error">
                        <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <div class="card card-border border-base-300 bg-base-100">
            <div class="card-body">
                <h2 class="card-title">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" class="text-success">
                        <path fill-rule="evenodd" clip-rule="evenodd"
