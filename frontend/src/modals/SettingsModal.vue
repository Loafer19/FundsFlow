...
const saveSettings = () => {
    ...
    Settings.updateDateFormat(formatDate.value)
    Settings.updateMoneyFormat(formatMoney.value)
    Settings.updateDecimals(decimals.value)
    Settings.updateTheme(themeSelected.value)
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            toasts.info('Refresh page to apply all changes :)')
        }, 400)
    }, 150)
}
</script>
