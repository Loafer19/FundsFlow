        ...
        <div class="modal-box max-w-sm">
                ...
                <form @submit.prevent="handleSubmit">
                    ...
                    <div class="modal-action justify-between">
                        <div class="flex gap-2">
                            ...
                            <button type="button" class="btn btn-ghost btn-square tooltip"
                                data-tip="Log in with a code from the Telegram bot" @click="showTelegramLogin = true">
            ...
            <template v-else>
                ...
                <p class="text-sm text-base-content/60 mb-4">
                    Open your FundsFlow bot in Telegram, send <code>/website</code>, and enter the code you get
                    below.
                </p>

                <input v-model="telegramCode" type="text" inputmode="numeric" maxlength="6"
                    placeholder="Code from the bot" class="input w-full mb-4" />

                <div class="modal-action justify-between">
                    <button type="button" class="btn btn-ghost btn-sm" @click="showTelegramLogin = false">
                        Back
                    </button>

                    <button type="button" class="btn btn-success" :disabled="authStore.isLoading || !telegramCode"
                        @click="submitTelegramCode">
                        <span v-if="authStore.isLoading" class="loading loading-spinner"></span>
                        <LogIn :size="24" />
                        Log in
                    </button>
