<template>
    <dialog id="transactions_add_modal" class="modal" aria-labelledby="transactions_add_modal_title">
        <div class="modal-box max-w-sm">
            <h2 id="transactions_add_modal_title" class="card-title mb-4">Add Transaction</h2>
